...
class TestLocal:
    ...
    async def test_register(self, dataservice_auth_local: LocalAuthDataService):
        ...
        user, token = await dataservice_auth_local.register(email=email, password=password)
    ...
    async def test_login(self, dataservice_auth_local: LocalAuthDataService,
    ...
    async def test_get_user_from_token(self, dataservice_auth_local: LocalAuthDataService,
                                       dataservice_auth_local_user: tuple[User, str, str]):

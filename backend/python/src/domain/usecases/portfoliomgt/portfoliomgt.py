...
class PortfolioMgt:
    ...
    async def compute_portfolio_valuation(self, portfolio_id: int) -> PortfolioValuation:
        ...
        for a in assets:
            ...
            if asset_price is not None:
                ...
                valuation_lines.append(ValuationLine(symbol=a.symbol,quantity=a.quantity, price=asset_price, value=valuation))
                total += valuation
            else:
                unkown_symbols.append(symbol)
        value = PortfolioValuation(portfolio_id=portfolio_id,total_value=total, lines=valuation_lines, unknown_symbols=sorted(list(set(unkown_symbols))))
